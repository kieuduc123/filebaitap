...
// 1. Location // tra  ra đường dẫn  v
console.log(location);
console.log(window.location);
// setTimeout(() => {
//   location.href = "https://evon.dev";
// }, 1000);
let params = new URLSearchParams(location.search);  // lấy ra giá trị 
console.log(params);
...
// history.go();/// quay lại trang trước đó khi nhiều tab 
// 3. Navigator // check người dùng vào bằng thiết bj gì 
